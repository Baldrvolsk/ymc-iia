...
val W = <liquid:water>;
val ND = <liquid:nutrient_distillation>;
Mixer.addRecipe(null, ND * 1000, [<minecraft:beef>, <minecraft:sugar>], W * 3000, 100, 16);
Mixer.addRecipe(null, ND * 1000, [<minecraft:chicken>, <minecraft:sugar>], W * 3000, 100, 16);
Mixer.addRecipe(null, ND * 1000, [<minecraft:porkchop>, <minecraft:sugar>], W * 3000, 100, 16);
Mixer.addRecipe(null, ND * 1500, [<minecraft:rotten_flesh>, <minecraft:sugar>], W * 3000, 140, 16);

recipes.addShaped(<EnderIO:blockKillerJoe>, [
	[<gregtech:gt.metaitem.01:17364>, <gregtech:gt.metaitem.01:17364>, <gregtech:gt.metaitem.01:17364>],
	[<extracells:certustank>, <EnderIO:itemFrankenSkull:2>, <extracells:certustank>],
	[<extracells:certustank>, <gregtech:gt.blockmachines:53>, <extracells:certustank>]]);

recipes.addShaped(<EnderIO:blockWirelessCharger>, [
	[<appliedenergistics2:item.ItemMultiMaterial:41>, <appliedenergistics2:item.ItemMultiMaterial:42>, <appliedenergistics2:item.ItemMultiMaterial:41>],
	[<gregtech:gt.blockmachines:4115>, <EnderIO:itemFrankenSkull:3>, <gregtech:gt.blockmachines:4115>],
	[<gregtech:gt.blockmachines:4115>, <gregtech:gt.blockmachines:12>, <gregtech:gt.blockmachines:4115>]]);